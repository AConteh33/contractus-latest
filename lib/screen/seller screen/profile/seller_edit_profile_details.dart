  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              textInputAction: TextInputAction.next,
                              decoration: kInputDecoration.copyWith(
                                hintText: data.authData.value!.aboutme,
      ...
      bottomNavigationBar: ButtonGlobalWithoutIcon(
          ...
          onPressed: () {
            currentIndexPage < 1;
            currentIndexPage < 1 ? pageController.nextPage(duration: const Duration(microseconds: 3000), curve: Curves.bounceInOut) : const SellerProfileDetails().launch(context);
          },
